...
const Login = () => {
  ...
  const [mobile,setMobilelogin]=usestate('');
  onst [otp, setOtp] = useState('');
const [otpSent, setOtpSent] = useState(false);
  ...
  // const Mobile_only=asyc()=>{
    
  //  const response=await axios.get('http://localhost:5000/api/auth/mobile-only');
  // }
  return (
    <div style={{ 
      minHeight: '100vh', 
