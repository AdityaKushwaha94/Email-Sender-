      ...
      {campaigns.length === 0 ? (
        <div style={styles.emptyState}>
          ...
          <p style={styles.emptyDescription}>
            Create your first email campaign to get started with professional email marketing!
          </p>
        </div>
      ) : (
            ...
            return (
              <div 
                ...
                onMouseOut={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 1px 3px 0 rgba(0, 0, 0, 0.3), 0 1px 2px 0 rgba(0, 0, 0, 0.2)';
                }}
              >
